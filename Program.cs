...
namespace RdpOutput
{
	internal class Program
	{
		...
		private static Set Char_stop = new Set();
		private static Set Comment_first = new Set();
		private static Set Comment_stop = new Set();
		private static Set CompilationUnit_first = new Set();
		private static Set CompilationUnit_stop = new Set();
		private static Set EntityDeclaration_stop = new Set();
		private static Set Identifier_stop = new Set();
		private static Set String_stop = new Set();
		private static Set UsingDirective_stop = new Set();
		private static Set rdp_CompilationUnit_4_first = new Set();
		...
		protected static void CompilationUnit()
		{
		...
		private static void EntityDeclaration()
		{
		...
		private static void UsingDirective()
		{
		...
		public static void Main(string[] args)
		{
			...
			text_init(rdp_textsize, 25, 100, rdp_tabwidth);
			scan_init(false, false, false, false, rdp_tokens);
			rdp_set_initialise();
			rdp_load_keywords();
